...
function gsfit_fastcode
  ...
  if !version.os_family eq 'Windows' then begin
    case !version.arch of
      'x86_64':renderer=gx_findfile(folder='userslib'+path_sep()+'radio_flaring'+path_sep()+'unix')+'GS_Transfer_Slice_64_DP.pro'
      else:which,renderer=gx_findfile(folder='userslib'+path_sep()+'radio_flaring'+path_sep()+'unix')+'GS_Transfer_Slice_32.pro'
    endcase
